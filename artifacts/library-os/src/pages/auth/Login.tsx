...
export default function Login() {
  ...
  return (
    <AuthLayout>
      <div>
        <h2 className="text-2xl font-bold text-foreground mb-1">Sign in to LibraryOS</h2>
        <p className="text-sm text-muted-foreground mb-7">
          Don't have an account?{" "}
          <Link href="/login" className="text-primary hover:underline font-medium">Create one</Link>
        </p>
              ...
              <FormItem>
                ...
                <FormControl>
                  <div className="relative">
                    <Input {...field} type={showPass ? "text" : "password"} placeholder="••••••••" className="h-10 pr-10" data-testid="input-password" />
        ...
        <Button variant="outline" className="w-full h-10 gap-2 text-sm" type="button">
